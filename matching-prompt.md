...
7. **Competition and physique goals.** Where a client's primary driver is preparing for a fitness event (HYROX, Turf Games) **or** building muscle and physique with a performance edge, **Dan is a strong candidate** — he is the roster's competition-prep and bodybuilding specialist. His exclusions apply strictly: he is not a candidate where an injury, rehab, pre/postnatal or older-adult medical flag is present.
8. **Generalist coaching and longevity goals.** Where a client's needs are broad rather than specialist — general fitness, getting started and building a habit, training for longevity and long-term health, or straightforward weight management and recomposition — **Adam is a strong candidate**. He is a deliberate generalist and works across almost every population. For that same reason, do not default to him when a client has a clear specialist need that another coach owns (women's health, martial arts, Olympic lifting, competitive sport, event prep, injury). A specialist with the right fit always outranks a generalist.
9. **Read between the lines.** A client who says "I want to get back to compound lifting after a shoulder injury and eventually do HYROX" is telling you their specialism needs, their injury context, and their performance direction — all three should influence the match.
