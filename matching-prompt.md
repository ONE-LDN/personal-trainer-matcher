...
8. **Read between the lines.** A client who says "I want to get back to compound lifting after a shoulder injury and eventually do HYROX" is telling you their specialism needs, their injury context, and their performance direction — all three should influence the match.
